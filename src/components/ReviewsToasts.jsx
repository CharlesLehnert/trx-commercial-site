...
const DEFAULT_REVIEWS = [
  {
    ...
    text: "Flawless install and super clean crew. Insurance was simple with their help.",
  },
  {
    name: "David R.",
    city: "Rockford, IL",
    text: "They found hail damage the adjuster missed and handled docs. Highly recommend.",
  },
  {
    name: "Emily K.",
    city: "Loves Park, IL",
    text: "Zero pressure, fair price, and the roof looks amazing.",
  },
  {
    name: "Mike H.",
    city: "Roscoe, IL",
    text: "Fast leak repair before a storm. Great communication.",
  },
  {
    name: "Jasmine T.",
    city: "Belvidere, IL",
    text: "On time, respectful crew, and pristine cleanup. A+.",
  },
];
...
export default function ReviewsToasts({ reviews = DEFAULT_REVIEWS }) {
  ...
  useEffect(() => {
    ...
    const hasSeenToast = sessionStorage.getItem("seenReviewToast");

    if (!hasSeenToast) {
      spawnToast();
      sessionStorage.setItem("seenReviewToast", "true");
    }
  }, []);
  ...
  return (
    <div className="flex items-center gap-1.5">
      <svg width="20" height="20" viewBox="0 0 48 48" aria-hidden="true">
        <path
          fill="#FFC107"
          d="M43.6 20.5H42V20H24v8h11.3C33.9 31.9 29.4 35 24 35c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.3 0 6.3 1.2 8.6 3.3l5.7-5.7C34.5 3.5 29.5 1.5 24 1.5 12.1 1.5 2.5 11.1 2.5 23S12.1 44.5 24 44.5 45.5 34.9 45.5 23c0-1.7-.2-3.2-.6-4.5z"
        />
        <path
          fill="#FF3D00"
          d="M6.3 14.7l6.6 4.8C14.6 15.8 18.9 13 24 13c3.3 0 6.3 1.2 8.6 3.3l5.7-5.7C34.5 3.5 29.5 1.5 24 1.5 15.5 1.5 8.1 6.3 6.3 14.7z"
        />
        <path
          fill="#4CAF50"
          d="M24 44.5c5.4 0 10.4-1.8 14.3-4.9l-6.6-5.4c-2 1.3-4.6 2.1-7.7 2.1-6 0-11.1-4-12.9-9.4H4.4v5.9C8.3 39.8 15.6 44.5 24 44.5z"
        />
        <path
          fill="#1976D2"
          d="M45.5 23c0-1.1-.1-2.1-.3-3.1H24v6.1h11.5c-.5 3-2.1 5.6-4.3 7.3l6.6 5.4C41.9 35.7 45.5 29.9 45.5 23z"
        />
      </svg>
